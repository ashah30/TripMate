...
function initMap() {
    ...
    document.getElementById('cityname-result').addEventListener('change', setAutocompleteCountry);
}
...
function search() {
    var search = {
        ...
        types: ['museum', 'amusement_park', 'place_of_worship', 'park', 'aquarium', 'art_gallery', 'church', 'zoo']
    };
...
function setAutocompleteCountry() {
    var country = document.getElementById('cityname-result').value;
    if (country == 'all') {
